...
def build_optimizations_section(panel: HRMTrainingPanel, parent: any) -> None:  # type: ignore[valid-type]
    ...
    try:
        ...
        add_tooltip(zero_combo, "DeepSpeed ZeRO: Distributed memory optimization\n• none: Standard training\n• zero1: Partition optimizer states (↓25% VRAM) - Windows/Linux\n• zero2: Partition optimizer + gradients (↓50% VRAM) [RECOMMENDED] - Windows/Linux\n• zero3: Partition everything (↓75% VRAM, slower) - Linux only, 2+ GPUs")
