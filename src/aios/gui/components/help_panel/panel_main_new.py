...
class HelpPanel(ttk.LabelFrame):  # type: ignore[misc]
        ...
        try:
            if self.html_view is not None:
                html_page = (
                    ...
                    "background:#fff; color:#24292f; padding:16px; line-height:1.6;}"
                    "p{margin:0;}"
    ...
    def _create_styled_html_page(self, html_content: str) -> str:
        ...
        return (
            ...
            "background:#fff; color:#24292f; padding:16px; line-height:1.6;}"
            "h1,h2,h3{border-bottom:1px solid #d0d7de; padding-bottom:.3em; margin-top:1.5em;}"
            ...
            ".warn{background:#fff8c5;border:1px solid #e3cc00;padding:10px;"
