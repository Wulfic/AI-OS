"""Run optimization comparison tests with C: drive temp storage to avoid Z: drive interrupts.
...
# Use C: drive for temp storage (Z: drive causes interrupts)
...
def run_optimization_tests():
    ...
    print("\n" + "="*80)
    print("Optimization Comparison Tests (C: drive storage)")
    print("="*80)
    ...
    for opt_config in OPTIMIZATIONS:
        for context_size in CONTEXT_SIZES:
            ...
            # Create test config with C: drive paths
            ...
            if torch.cuda.is_available():
                ...
                try:
                    ...
                    print("  [Sleep interrupted, continuing...]")
                    pass
